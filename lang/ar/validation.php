...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'address'               => 'العنوان',
        'parent_full_name'      => 'الاسم الكامل للأهل',
        'parent_phone_number'   => 'رقم هاتف الأهل',
        'birth_date'            => 'تاريخ التولد',
        'group_id'              => 'رقم تعريف المجموعة',
        'files'                 => 'الملفات',
        'files.*.file'          => 'الملف',
        'files.*.description'   => 'الوصف',
        'position_id'           => 'رقم تعريف الموقف',
        'trip_id'               => 'رقم تعريف الرحلة',
        'name'                  => 'الاسم',
        'children_count'        => 'عدد الأطفال',
        'age_type_id'           => 'رقم تعريف نوع العمر',
        'program_id'            => 'رقم تعريف البرنامج',
        'sessionsIds.*'         => 'أحد أرقام تعريف الجلسات',
        'sessionsIds.*'         => 'أحد أرقام تعريف الجلسات',
        'facilitatorsIds.*'     => 'أحد أرقام تعريف الميسرين',
        'child_id'              => 'رقم تعريف الطفل',
        'challenge_id'          => 'رقم تعريف التحدي',
        'description'           => 'الوصف',
    ],
